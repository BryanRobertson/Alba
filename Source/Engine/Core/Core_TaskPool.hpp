	...
	namespace Core
	{
		...
		class TaskPool final
		{
			public:
				...
				//--------------------------------------------------------------------------------
				// Reset state at the start of the frame
				//--------------------------------------------------------------------------------
				void	Reset();
			...
			private:
				...
				// TODO: Should this be atomic? In theory we never access/modify from any other thread
		...
		//-----------------------------------------------------------------------------------------------
		//-----------------------------------------------------------------------------------------------
		inline bool	TaskPool::IsFull() const
		{
			return myNextFreeTaskIndex == ourTaskPoolSize;
		}
	}
}